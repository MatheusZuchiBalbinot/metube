...
interface ChannelDiamondTiersProps {
    videos: Video[]
    onNavigate: (id: VideoId) => void
}

export default function ChannelDiamondTiers({ videos, onNavigate }: ChannelDiamondTiersProps) {
    return (
                ...
                >
                    <div className="channel-page__diamond-overlay">
                        <div className="channel-page__diamond-info">
                            ...
                            <span className="channel-page__diamond-title">{videos[0].title}</span>
                            <span className="channel-page__diamond-views">{Format.views(videos[0].views)}</span>
                        </div>
                    </div>
                </div>
            </div>
