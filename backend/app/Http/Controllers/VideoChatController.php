...
{
    // Transcription is truncated to keep the prompt within model limits.
    private const TRANSCRIPTION_MAX_CHARS = 8000;
    ...
    {
        $truncatedTranscription = mb_substr($transcriptionContent, 0, self::TRANSCRIPTION_MAX_CHARS);
