...
class VideoTranscriptionFailedNotification extends Notification
{
    use IncludesVideoThumbnail;

    /**
     * @param Video $video The video whose transcription exhausted all retries
     */
    ...
    {
        return [
            'type' => NotificationType::VIDEO_TRANSCRIPTION_FAILED->value,
